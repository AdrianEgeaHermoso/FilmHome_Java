...
<html>
    ...
    <body style="background: url(./images/fondo1.jpg); padding: 10px">
        ...
        <a class="btn btn-primary btn-lg" href="altas.jsp"><img src="./images/cloud-plus-fill.svg" alt="x" width="50px" height="60px"/> Alta de Películas</a>
        <br>
        ...
        <table class="table table-bordered" >
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td><%=listado.getInt("precio") + " \u20AC"%></td>
                    <td><%=listado.getString("formato")%></td>
                    <td><%=listado.getInt("puntuacion")%></td>
                    <td><a class="btn btn-warning btn-sm"><img src="./images/pencil-fill.svg" alt="x" /><p></p>Editar</a></td>
                    <td><a class="btn btn-danger btn-sm"><img src="./images/trash-fill.svg" alt="x" /><p></p>Eliminar</a></td>
